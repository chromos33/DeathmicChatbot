...
var StreamCommandCreate = /*#__PURE__*/function (_React$Component) {
    _inherits(StreamCommandCreate, _React$Component);

    var _super = _createSuper(StreamCommandCreate);

    function StreamCommandCreate(props) {
        var _this;

        _classCallCheck(this, StreamCommandCreate);
    ...
    _createClass(StreamCommandCreate, [{
        key: "handleTypeClick",
        ...
        value: function handleSave(e) {
            if (this.state.CanSave && this.state.Change) {
                ...
                request.send("Name=" + this.state.Name + "&Response=" + this.state.Response + "&Mode=" + this.state.Mode + "&StreamID=" + streamID);
            } else {
                this.setState({
                    Open: false
                });
        ...
        value: function render() {
            if (this.state.Open) {
                ...
                return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", {
                    className: "pointer btn btn_primary mb-3"
                }, /*#__PURE__*/React.createElement("i", {
                    className: "fa fa-plus"
                }), " Erstellen"), /*#__PURE__*/React.createElement("div", {
                ...
                }, "Erstellen"), /*#__PURE__*/React.createElement("span", {
