...
namespace BobDeathmic.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> TwitchReturnUrlAction(string code, string scope, string state)
        {
            ...
            string url = $"https://id.twitch.tv/oauth2/token?client_id={savedtoken.ClientID}&client_secret={test.secret}&code={code}&grant_type=authorization_code&redirect_uri=https://localhost:44347/admin/TwitchReturnUrlAction";
