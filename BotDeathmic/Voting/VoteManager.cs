...
namespace DeathmicChatbot
{
    public class VoteManager
    {
        ...
        */
        ...
        public void StartVoting(String user,
                                string question,
                                List<string> answers,
                                DateTime endTime)
        {
        ...
        public void EndVoting(string user, int index)
        {
            if (!_votings.ContainsKey(index))
                throw new ArgumentOutOfRangeException("index");
            if (_votings[index]._userInfo.ToLower() != user.ToLower())
        ...
        public void Vote(string user, int index, string answer)
        {
            if (!_votings.ContainsKey(index))
                throw new ArgumentOutOfRangeException("index");
            ...
            voting._votes[user.ToLower()] = answer;
        ...
        public void RemoveVote(string user, int index)
        {
            if (!_votings.ContainsKey(index))
                throw new ArgumentOutOfRangeException("index");
            var voting = _votings[index];
            voting._votes.Remove(user.ToLower());
